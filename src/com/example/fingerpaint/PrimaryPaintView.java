 ...
 * which are 3 color on the application
 */
public class PrimaryPaintView extends View{
	private static final String TAG = PrimaryPaintView.class.getSimpleName();
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			Log.i(TAG, "onTouchEvent:move y= " + y);
			onTouchMove(y);
			return true;
	...
	private void onTouchMove(float y){
		...
		Log.i(TAG, "onTouchMove:factor= " +factor+ " colorPercent= " +colorPercent);
		invalidate();
	}
