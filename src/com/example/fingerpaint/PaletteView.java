...
/**
 * The palette view, which controls displaying the selector, the mix button, 3primary colors,
 *  and the 7 custom paints
 */
...
public class PaletteView extends ViewGroup{
    ...
    public boolean removeCustomPaintView(CustomPaintView v){
    	if(!inMixMode && 
    			v != currentCustomPaintView && 
    			customPaintViews.size() > MIN_CUSTOM_COLORS){
